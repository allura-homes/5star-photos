...
const FAQ = [
  ...
  },
  {
    ...
    a: "Every plan runs V1, V2, V3, and V4 (in beta) on each transform. Pro and Max also run every additional model we have enabled, so you see more candidates side by side and pick the best one.",
  },
  {
