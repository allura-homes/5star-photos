    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="flex gap-1 p-1 mb-6 rounded-xl bg-slate-900/50 border border-slate-700">
            <button
              type="button"
              onClick={() => {
                setMethod("email")
              ...
              className={`flex-1 inline-flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition-colors ${
                method === "email" ? "bg-amber-500 text-black" : "text-slate-400 hover:text-white"
              }`}
            ...
            <button
              ...
              className={`flex-1 inline-flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition-colors ${
                method === "phone" ? "bg-amber-500 text-black" : "text-slate-400 hover:text-white"
              }`}
          ...
          {method === "phone" ? (
            <PhoneLoginForm redirect={redirect} />
          ) : (
            <>
              {error && (
